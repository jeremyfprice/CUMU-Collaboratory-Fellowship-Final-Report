...
Important for p&t funders etc. [@shephardValuingEvaluatingCommunityengaged2018] [@wendlingEvaluatingCommunityEngagedResearch2023] [@lewisLongitudinalMultisiteEvaluation2023]
...
### Reorienting Metrics to What Matters

As @hauserMetricsYouAre1998 have made clear, "you are what you measure."

## Existing Work in Reflecting, Reporting, and Evaluating Community Engaged Scholarship

Not a comprehensive review like [@lugerMeasuringCommunityEngagedResearch2020] or [@bowenSystematicReviewQuantitative2017]

### The Nature of Partnerships

TRES 1.0 [@claytonDifferentiatingAssessingRelationships2010]

[@aroraMeasuringCommunityBasedParticipatory2015] [@keyContinuumCommunityEngagement2019] [@dostilioDemocraticallyEngagedCommunity2014]

### Processes and Outcomes

[@schulzInstrumentEvaluatingDimensions2003] and TRES 2.0 [@kniffinRelationshipsPartnershipsCommunity2020]  [@goodmanEVALUATINGCOMMUNITYENGAGEMENT2017] [@boursawScalesPracticesOutcomes2021]

### Impacts

[@alvarezParticipatoryImpactPathways2010] [@chazdonFieldGuideRipple2017] [@reedProgramEvaluationCommunityengaged2015]
...
2. *Direct Indicator Scores* which include measures such as contact hours, individuals served, and number of products created.
3. *Alignment Score Development* to create a way to demonstrate alignment between the research team and community partners;
4. *Project Dynamics Score Development* to design scores that demonstrate the workings and outcomes of the research project, which included determining weightings of the descriptors; and
5. *Cascade Effects Score Development* to develop a way to understand the social reach of the project.
...
The two weights---the attribute weight and the ranking weight---are multipled together which results in an attribute value (@eq-attribute-score).
$$
v_a = w_a \times w_r
$$ {#eq-attribute-score}
...
In @eq-attribute-weights, $w_c$ is the *calculated* attribute weight for the purposes of a weighted mean, ${v_a}$ is the value of the attribute ($w_a \times w_r$), and $\sum_{j=1}^{n}v_j$ is the sum of the calculated attribute values.
...
Different than ripple effects mapping [@chazdonFieldGuideRipple2017, @muhlesteinAssessingCommunityEngagedLearning2019, @zimmermanAssessingImpactsRipple2019]. More like [@longBridgesBrokersBoundary2013].

Three degrees of impact [@christakisConnectedSurprisingPower2009]
